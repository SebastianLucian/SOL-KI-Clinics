...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "crmName", label: "Which CRM / system?", type: "select", options: ["Doctolib", "Jameda", "Dr. Flex", "Dentally", "Dampsoft", "Google Calendar", "HubSpot", "Salesforce", "Other"], conditional: (data) => data.hasCRM === "Yes" },
      ...
      { key: "sendConfirmation", label: "Should the agent send appointment confirmations to clients?", type: "select", options: ["Yes", "No"] },
      ...
      { key: "emergencyNumber", label: "Emergency / after-hours number", type: "text", placeholder: "e.g. +49 123 456 789", conditional: (data) => data.afterHoursBehavior === "Redirect to emergency number" },
